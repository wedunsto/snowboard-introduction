...
import { ridingDownHillLesson } from 'src/assets/data/lessons/beginner-lessons';
import { addInstructionText, isButtonDisabled } from 'src/app/shared/helper-functions/lesson-helper-functions';

@Component({
  selector: 'app-riding-down-hill',
  templateUrl: './riding-down-hill.page.html',
  styleUrls: ['./riding-down-hill.page.scss'],
  standalone: true,
  imports: [
    IonContent,
    CommonModule,
...
export class RidingDownHillPage {
  // Initialize the utility array with the first instruction text
  lessonInstructions: string[] = [ridingDownHillLesson[0]];
